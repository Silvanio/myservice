...
public class ImportController {
    ...
    @PostMapping(value = "/uploadHistoricalIBOV", consumes = {"multipart/form-data"})
    public ResponseMessageDTO uploadHistoricalIBOV(@RequestParam("file") MultipartFile file) {
        importFileService.uploadHistoricalIBOV(file);
        return ResponseMessageDTO.get("msg_general_success");
    }
